                        ...
                        if(!$codeProd=="" && !$nameProd=="" && !$cateProd=="" && !$priceProd=="" && !$modelProd=="" && !$marcaProd=="" && !$stockProd=="" && !$codePProd=="" && !$_FILES['img']['name']==""){
                            ...
                            if($verificaltotal<=0){
                                if(move_uploaded_file($_FILES['img']['tmp_name'],"../assets/img/products/".$_FILES['img']['name'])){
                                    if(consultasSQL::InsertSQL("producto", "CodigoProd, NombreProd, CodigoCat, Precio, Modelo, Marca, Stock, RUCProveedor, Imagen, Nombre", "'$codeProd','$nameProd','$cateProd','$priceProd', '$modelProd','$marcaProd','$stockProd','$codePProd','".$_FILES['img']['name']."','$adminProd'")){
                                        echo '
                                            <img src="../assets/img/correctofull.png" class="center-all-contens">
                                            <br>
                                            <h3>El producto se añadió a la tienda con éxito</h3>
                                            <p class="lead text-center">
                                                La página se redireccionará automáticamente. Si no es así, haga click en el siguiente botón.<br>
